...
set shortmess=aoO
badd +220 PlayState.as
badd +0 ..\..\..\org\flixel\FlxSprite.as
badd +0 ..\..\..\..\freedom.txt
args PlayState.as
edit PlayState.as
...
exe 'vert 1resize ' . ((&columns * 113 + 66) / 133)
exe '2resize ' . ((&lines * 29 + 16) / 33)
exe 'vert 2resize ' . ((&columns * 113 + 66) / 133)
exe 'vert 3resize ' . ((&columns * 19 + 66) / 133)
argglobal
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 35 - ((19 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
35
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 793 - ((6 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
793
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 158 - ((29 * winheight(0) + 15) / 31)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
158
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((14 * winheight(0) + 7) / 15)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
